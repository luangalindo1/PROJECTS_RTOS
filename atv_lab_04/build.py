...
cSourceList.append(projfile.ProjectFile("blink.cpp"))
...
cSourceList.append(projfile.ProjectFile("blink/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab03_2.hex from lab03_2")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab03_2")
  postCommand.mCommand.append("lab03_2.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab03_2 on avr/arduino/nano\033[0m")
