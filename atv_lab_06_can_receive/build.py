...
#--- from root OIL file can_receive.oil
#---
...
#--- OIL file
oilSourceList.append("can_receive.oil")
...
cSourceList.append(projfile.ProjectFile("can_receive.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("can_receive/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("can_receive/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("can_receive/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("can_receive/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab06_receive.hex from lab06_receive")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab06_receive")
  postCommand.mCommand.append("lab06_receive.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab06_receive on avr/arduino/nano\033[0m")
