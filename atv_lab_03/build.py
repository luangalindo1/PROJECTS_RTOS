...
if True:
  postCommand = makefile.PostCommand("Generating binary lab03.hex from lab03")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab03")
  postCommand.mCommand.append("lab03.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab03 on avr/arduino/nano\033[0m")
