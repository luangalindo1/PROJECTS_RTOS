...
if True:
  postCommand = makefile.PostCommand("Generating binary lab02_b.hex from lab02_b")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab02_b")
  postCommand.mCommand.append("lab02_b.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab02_b on avr/arduino/nano\033[0m")
