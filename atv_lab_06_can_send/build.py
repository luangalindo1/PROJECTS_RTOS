...
if True:
  postCommand = makefile.PostCommand("Generating binary lab06_send.hex from lab06_send")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab06_send")
  postCommand.mCommand.append("lab06_send.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab06_send on avr/arduino/nano\033[0m")
