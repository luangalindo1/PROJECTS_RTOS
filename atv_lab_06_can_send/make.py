...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file can_send.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../../goil/templates/ can_send.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("can_send/tpl_app_config.c")

sourceList.append("can_send/tpl_dispatch_table.c")
sourceList.append("can_send/tpl_invoque.S")
sourceList.append("can_send/tpl_interrupts.c")
