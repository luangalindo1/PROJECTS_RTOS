...
#--- from root OIL file can_send.oil
#---
...
#--- OIL file
oilSourceList.append("can_send.oil")
...
cSourceList.append(projfile.ProjectFile("can_send.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("can_send/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("can_send/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("can_send/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("can_send/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary PROJECT_TCM.hex from PROJECT_TCM")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("PROJECT_TCM")
  postCommand.mCommand.append("PROJECT_TCM.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing PROJECT_TCM on avr/arduino/nano\033[0m")
